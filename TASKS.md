...
**当前状态**: Web 和 API 已部署，环境变量已配置，数据库迁移已完成。智能合约已部署到 Sepolia 测试网。Telegram Bot 已部署。
...
**部署信息**:
- URL: https://alphanest-telegram-bot.dappweb.workers.dev
- KV: SUBSCRIPTIONS (653be5fe9c01498baa76780f7503e4b3)

**待配置** (需用户操作):
- [ ] 创建 Telegram Bot (@BotFather)
- [ ] 配置 Bot Token: `npx wrangler secret put TELEGRAM_BOT_TOKEN`
- [ ] 设置 Webhook: POST https://alphanest-telegram-bot.dappweb.workers.dev/setup-webhook
