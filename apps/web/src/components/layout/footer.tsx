...
const socialLinks = [
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/popcowxyz',
...
const footerLinks = [
  ...
  },
  {
    title: 'Resources',
    links: [
      { name: 'Documentation', href: 'https://app.popcow.xyz/docs', external: true },
      ...
      { name: 'Brand Kit', href: 'https://github.com/popcowxyz', external: true },
    ],
  },
  {
    title: 'Community',
    links: [
      ...
      { name: 'Blog', href: 'https://x.com/popcowxyz', external: true },
    ],
  },
  {
    title: 'Legal',
